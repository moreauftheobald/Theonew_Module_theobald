 ...
 * Copyright (C) 2019       Fr√©d√©ric France         <frederic.france@netlogic.fr>
...
class modtHEOBALD extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->description = "Module spÈcifique thÈobald Trucks";
    ...
    public function init($options = '')
    {
        ...
        $result1=$extrafields->addExtraField('gdscom', "Compte GDS Commercial", 'varchar', 1,  255, 'thirdparty',   0, 1, 1,'' , 1, '', 1, '', '', 0, 'theobald@theobald', '$conf->theobald->enabled');
        $result1=$extrafields->addExtraField('gdsapv', "Compte GDS Apres Vente", 'varchar', 1,  255, 'thirdparty',   0, 1, 1,'' , 1, '', 1, '', '', 0, 'theobald@theobald', '$conf->theobald->enabled');
